...
(function ($) {
    ...
    TagsInput.prototype = {
        ...
        add: function (item, dontPushVal, options) {
            ...
            var itemValue = self.options.itemValue(item), itemText = self.options.itemText(item), tagClass = self.options.tagClass(item), itemTitle = self.options.itemTitle(item);
            ...
            var optionExists = ($('option[value="' + encodeURIComponent(itemValue) + '"]', self.$element).length ||
